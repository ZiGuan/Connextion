...
def question1():
    ans1 = input(">>Do you have any job experience? (Please answer 'yes' or 'no')\n")
    if ans1 == 'yes':
        return question1a()
    elif ans1 =='no':
        return question1b()
...
def question3():
    ans3 = input('\n>>Please higlight your major \n-Engineering & Technology Related  \n-Business Related  \n-Environmental Related  \n-Literature, Language & Social Science Related\n')  
...
def question6():
    print('>>\nPlease add relevant information about you.')
    ans6a = input('Phone Number:')
    ans6b = input('Email:')
    ans6c = input('Address:')
    ans6d = input('Nationality:')

def run():
    print ('Hi there! Please fill in your details before we start.')
    question1()
    question3()
    question4()
    question5()
...
def main():
    ...
    user_input = input("""
Would you like to take the Meyers Briggs Personality Test?
Press 1 - YES
Press 2 - NO -> """)
    try:
